...
class Pflare(MakefilePackage):
    ...
    url = "https://github.com/PFLAREProject/PFLARE/archive/refs/tags/v1.23.tar.gz"
    ...
    version("1.24", sha256="09c2e546d7a53c967263d2979b478951f0bae16fae152573be6e4a8afb0bba78")
